...
void Sudoku::Sudoku::createInterfaceLayout()
{
	...
	/*----------------------------------------Hiển thị đồng hồ------------------------------------------*/
	//Làm phần đồng hồ không thể bấm được gì trong đó
	...
	int buttonHeight = (mWindowHeight - 6 * thinBorder - 6 * thickBorder) / 11; //chiều cao của đồng hồ trong màn hình
...
/****************************Sửa lỗi đồng hồ chạy sai giờ(fix về 00:00:00)*******************************************/
